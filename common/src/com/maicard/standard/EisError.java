...
public enum EisError {
	 ...
	 * ,"找不到指定的卡券产品"
	 */
	couponProductNotExist(500150), 
	
	
	/**
	 * ,"指定的卡券处理器为空"
	 */
	couponProcessorIsNull(500151), 
