 ...
 * get：列出对象数据
 */
public class Privilege extends EisObject implements Cloneable {
	...
	private int roleRelationStatus;	
	private String objectStatusName;
	private String roleRelationStatusName;
	...
	public int getRoleRelationId() {
		return roleRelationId;
	}

	public void setRoleRelationId(int roleRelationId) {
		this.roleRelationId = roleRelationId;
	}

	public int getRoleRelationStatus() {
		return roleRelationStatus;
	}

	public void setRoleRelationStatus(int roleRelationStatus) {
		this.roleRelationStatus = roleRelationStatus;
	}
	...
	public String getRoleRelationStatusName() {
		return roleRelationStatusName;
	}

	public void setRoleRelationStatusName(String roleRelationStatusName) {
		this.roleRelationStatusName = roleRelationStatusName;
	}
