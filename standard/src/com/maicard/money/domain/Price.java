...
public class Price extends EisObject implements Cloneable{
	...
	public String getFeeAdjectInfo() {
		return feeAdjectInfo;
	}

	public void setFeeAdjectInfo(String feeAdjectInfo) {
		this.feeAdjectInfo = feeAdjectInfo;
	}
