                                ...
                                <div class="wid-80 martop50">
                                        <div class="status_right">
                                            <div class="status"> 
                                                        ...
                                                        <span class="text_status">5.交易完成</span> <!--<span class="text_status">成功提交订单</span> -->
                                                    </div>
                                                    <div>
                                                        <div  style="float:left;width: 30%;display: flex;display:-webkit-flex;flex-direction: row;align-items: center;">
                                                            <div  style="height:2px;background:#cdcdcd;flex:1;"></div>
                                                            <img src="../../../theme/basic/images/jindu.png" alt="" style="width:20px;height:auto;">
                                                        </div>
                                                        <div  style="float:left;width: 20%;display: flex;display:-webkit-flex;flex-direction: row;align-items: center;">
                                                        ...
                                                        <div  style="float:left;width: 10%;display: flex;display:-webkit-flex;flex-direction: row;align-items: center;">
                                                            <img src="../../../theme/basic/images/jindu.png" alt="" style="width:20px;height:auto;">
                                                            <div  style="height:2px;background:#cdcdcd;flex:1;"></div>
                                                        </div>
                                                        <div  style="float:left;width: 10%;display: flex;display:-webkit-flex;flex-direction: row;align-items: center;">
                                                        ...
                                                        <!--<div style="float:left;width: 31%;height:2px;background:#cdcdcd;margin-top:9px;"></div>-->
                                                    </div>
                                                            ...
                                                            <c:forEach var="payType" items="${payTypeList}">
                                                                <c:choose>
                                                                    <c:when test="${payType.payTypeId == 1}">
                                                                        <li style="margin-top: 16px;"><input type="radio" name="checkit" checked value="${payType.payTypeId}"/></li>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <li style="margin-top: 16px;"><input type="radio" name="checkit" value="${payType.payTypeId}"/></li>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                                <c:choose>
                                                                    <c:when test="${payType.payTypeId == 1}">
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${payType.payTypeId == 10}">
                                                                        <li style="margin-top: 16px;">${payType.name}</li>
                                                                    </c:when>
                                                                </c:choose>
                                                            </c:forEach>
