            ...
            <div id="main-content">
                <div id="content-header">
                    <div itemscope itemtype="http://schema.org/WebPage" id="breadcrumb">
                        ...
                        <img src="../../../theme/${theme}/images/right.png" alt=""> <span class="current">琴友作品</span></div>
                </div>
                                            ...
                                            <li class="video-thumb">
                                                <article>
                                                    <a class="pic" target="_blank" href="${item.viewUrl}" title="链接到  ${item.title}" rel="bookmark">
                                                        <c:choose>
                                                            <c:when test="${empty item.documentDataMap.productSmallImage}">
                                                                <img class="lazy" data-lazy-src="../../../theme/${theme}/images/LOGO.png" alt="#" style='width: 100%;height: 125px;' />
                                                            </c:when>
                                                            <c:otherwise>
