            ...
            <div id="main-content">
                <div id="content-header">
                    <div itemscope id="breadcrumb">
                        <a itemprop="breadcrumb" href="/" title="返回首页" class="tip-bottom"><img src="../../../theme/${theme}/images/souye.png" alt="" class='souye'>首页</a> <img src="../../../theme/${theme}/images/right.png" alt="" class='right'> <span class="current"> 金伟 的文章 </span></div>
                </div>
                            ...
                            <div class="widget-box" style='background: none repeat scroll 0 0 #F8F8F8;border-bottom: 0;'>
                                <div id="user-left">
                                    <div class="user-avatar">
                                        ...
                                        <p>金伟</p>
                                        <p class="user-pm">
                                            <a href="/user/bbsInformation.shtml?defaultReceiver=金伟"><img src="../../../theme/${theme}/images/jianyi.png" alt="" style='width: 12px;height:12px;border: 0;padding: 0;border-radius:0;transform:rotateZ(0);box-shadow: 0 0 0;'> 发送站内信</a>
                                        </p>
                                    </div>
                                    <ul id="user-menu">
                                ...
                                <div class="widget-content" id="user-right">
                                    <header id="post-header" style='width:100%;'>
                                        <h1 itemprop="headline">
                                            金伟 的文章 <a class="rss-cat-icon" title="订阅该作者的文章" href="#"><i class="icon-rss"></i></a>
                                        </h1>
                                    </header>
                                    <div class="post-count"> 金伟 已发布了 <span>${totalResults}</span> 篇文章：</div>
                                    <script>
                                        // $(function(){
