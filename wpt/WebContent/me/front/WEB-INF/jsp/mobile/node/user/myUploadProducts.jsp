                            ...
                            <div class="widget-box user-center">
                                <div id="user-left">
                                    ...
                                    <ul id="user-menu">
                                        ...
                                        <li class="current-menu-item"><a href="/user/myUploadProducts.shtml" style='background: url("../../../theme/${theme}/images/greenproduct.png") no-repeat;background-position-y: 4px;
