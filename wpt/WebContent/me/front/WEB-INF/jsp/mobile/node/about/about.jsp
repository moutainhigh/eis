    ...
    <%@include file="/WEB-INF/jsp/include/tags.jsp" %>
        ...
        <body id="top" class="home blog chrome">
            ...
            <div class="main-content-imgs">
                    <img data-lazy-src="../../../theme/${theme}/images/about1.png" alt="" style="margin-top: 3%;">
                    <img data-lazy-src="../../../theme/${theme}/images/about2.png" alt="" >
                    <img data-lazy-src="../../../theme/${theme}/images/about3.png" alt="" >
                    <img data-lazy-src="../../../theme/${theme}/images/about4.png" alt="" >
                    <img data-lazy-src="../../../theme/${theme}/images/about5.png" alt="" >
                    <img data-lazy-src="../../../theme/${theme}/images/about6.png" alt="" >
                    <img data-lazy-src="../../../theme/${theme}/images/about7.png" alt="" >
                    <img data-lazy-src="../../../theme/${theme}/images/about8.png" alt="" >
                    <img data-lazy-src="../../../theme/${theme}/images/about9.png" alt="" style="margin-bottom: 3%;">
            </div>
