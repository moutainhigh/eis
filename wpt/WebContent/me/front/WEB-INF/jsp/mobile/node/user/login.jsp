                                            ...
                                            <ul class="wpuf-form">
                                                <li class="wpuf-el ">
                                                    ...
                                                    <div class="wpuf-fields  wpuf_toc_5046">
                                                        <textarea rows="10" cols="40" disabled="disabled" name="toc" style="color: #000;">用户注册协议
                ...
                <input type="checkbox" checked="checked" id='checkout' /> 已阅读并同意协议条款            </span>
                                                ...
                                                <li class="wpuf-el user_login username">
                                                    ...
                                                    <div class="wpuf-fields">
                                                        <input class="textfield wpuf_user_login_5046" id="userName" type="text" name="username" value='' placeholder="不能含有空格" size="" />
                                                        <span class="wpuf-help" id='user_text'>不要超过6位数以及出现空格符号，否则有可能会被网站系统认定为广告ID</span>
                                                ...
                                                <li class="wpuf-el user_email email">
                                                    ...
                                                    <div class="wpuf-fields">
                                                        <input id="wpuf-user_email" type="email" class="email  wpuf_user_email_5046" data-required="yes" data-type="text" name="email" placeholder="非常重要！请填写您的常用手机号" value="" size="" />
                                                ...
                                                <li class="wpuf-el user_email email">
                                                    ...
                                                    <div class="wpuf-fields">
                                                        ...
                                                        <input type="button" class="btn_sendCode" id="btnSendCode" value="发送验证码" onclick="sendMessage();" style="padding: 5px;margin-top: 10px;margin-left: 0;">
                                                        <span class="wpuf-help" id='email_text'></span>
                                                    </div>
                                                ...
                                                <li class="wpuf-el password password">
                                                    ...
                                                    <div class="wpuf-fields">
                                                        <input id="userPassword" type="password" class="password  wpuf_password_5046" data-required="yes" data-type="text" name="userPassword" placeholder="至少7个字符" value="" size="" />
                                                ...
                                                <li>
                                                    ...
                                                    <div class="wpuf-fields">
                                                        <input id="userPassword2" type="password" class="password  wpuf_password_5046" data-required="yes" data-type="text" name="userPassword2" value="" size="" />
                                                    </div>
