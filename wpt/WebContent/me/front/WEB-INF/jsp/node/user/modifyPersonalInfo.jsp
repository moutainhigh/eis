                            ...
                            <div class="widget-box user-center">
                                <div id="user-left">
                                    ...
                                    <ul id="user-menu">
                                        ...
                                        <li><a href="/user/purchasedList.shtml?flag=product"><span class="icon-shopping-cart"></span>已购教学</a></li>
                                        ...
                                        <li class="current-menu-item"><a href="/user/modifyPersonalInfo.shtml" style='background: url("../../../theme/${theme}/images/greenset.png") no-repeat;
                                            ...
                                            <ul class="wpuf-form">
                                                <li class="wpuf-el user_login username">
                                                    ...
                                                    <div class="wpuf-fields">
                                                        <input class="textfield wpuf_user_login_5046" id="userName" type="text"  name="user_login" placeholder="用户名" value="${frontUser.username}" size="40" style="background:#f8f8f8;"/>
                                                        <span class="wpuf-help">请输入2至20个字符用户名</span>
                                                    </div>
                                                </li>                                               
