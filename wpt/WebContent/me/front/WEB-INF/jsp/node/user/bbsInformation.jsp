                            ...
                            <div class="widget-box user-center">
                                <div id="user-left">
                                    ...
                                    <ul id="user-menu">
                                        ...
                                        <li class="current-menu-item"><a href="/user/bbsInformation.shtml" style='background: url("../../../theme/${theme}/images/greenmessage.png") no-repeat;
