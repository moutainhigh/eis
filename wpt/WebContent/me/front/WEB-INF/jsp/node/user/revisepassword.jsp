<%@ page language="java" contentType="text/html; charset=UTF-8"	pageEncoding="UTF-8"%>
    <%@include file="/WEB-INF/jsp/include/tags.jsp" %>
        ...
        <body id="top" class="home blog chrome">
            ...
            <div id="main-content">
                <div id="content-header">
                    <div itemscope id="breadcrumb">
                        ...
                        <img src="../../../theme/${theme}/images/right.png" alt=""> <span class="current">找回密码</span></div>
                </div>
                            ...
                            <div class="widget-box" style='height: 80%;'>
                                <article class="widget-content single-post" itemscope itemtype="http://schema.org/Article">
                                    ...
                                    <div class="entry" itemprop="articleBody" style="display:flex;flex-direction: row;-ms-flex-direction:row;justify-content: center;display:-webkit-flex;" onkeydown="keyLogin();">
                                        <div class="login" id="wpuf-login-form" style="margin: 50px;width: 100%;">
                                            <form  class="wpuf-login-form" id="loginform" action="#" method="post">
                                                <p>
                                                    <label for="wpuf-user_login" style="width:120px;">用户名：</label>
                                                    <input type="text" name="log" id="usernames" class="input" value="" size="20" />
                                                </p>
                                                <p>
                                                    <label for="wpuf-user_login" style="width:120px;">手机号：</label>
                                                    <input type="text" name="log" id="wpuf-user_email" class="input" value="" size="20" />
                                                </p>
                                                <p>
                                                    <label for="wpuf-user_pass" style="width:120px;">验证码：</label>
                                                ...
                                                <p>
                                                    <label for="wpuf-user_pass" style="width:120px;">新密码：</label>
                                                    <input type="password" name="pwd" id="userPassword" class="input" value=""  placeholder="至少7个字符" value="" size="20"/>
                                                     <span class="wpuf-help" id='password_text'>*可用大小写字母、数字和符号，例如! " ? $ % ^ & )</span>
                                                </p>
                                                <p>
                                                    <label for="wpuf-user_pass" style="width:120px;">确认密码：</label>
                                                    <input type="password" name="pwd" id="userPassword2" class="input" value="" size="20" />
            ...
            <script src='../../../theme/${theme}/js/findpassword.js'></script>
