...
function showpage1(num){
	...
	if(num>=1){
		...
		TweenMax.to($('.page'),0,{css:{top:0},ease:SteppedEase.easeOut})
		...
		TweenMax.to($('.page').eq(num),1,{css:{top:"100%"},ease:Expo.easeOut})
...
$(document).ready(function() {
	...
	if(w>=768){
		...
		$(".page").show();
		 $(".nBtn").show();
		$(".pBtn").show();//setInterval(changeImg,10000);每隔timeInterval时间，执行一次changeImg事件
	}
