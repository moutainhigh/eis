    ...
    //    录音函数
        ...
        function startRecording(a) {
            if(a == name){
                alert('对不起,不能语音回复自己！');
            }else if(name == '七星乐器' || name == '杨猛' || name == '金伟'){
