                                    ...
                                    <c:choose> 
                                        <c:when test="${!empty message}"> 
                                            ...
                                            <c:if test="${message.operateCode==102169}">
                                                    ...
                                                    <script>   
                                                           $(function(){
                                                               $('#scanCode').append('<div class="iframeDiv"><iframe src="${message.message}" frameborder="0"  hspace="-100" vspace="-150" scrolling="no" style="width:100%;height:500px;"></iframe></div>');
                                                                // $(".box").css({"display":"block"});
                                                                // $(".hint").css({"display":"block"});
