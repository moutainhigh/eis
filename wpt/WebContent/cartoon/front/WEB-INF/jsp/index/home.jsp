            ...
            <div id="main-content">
                ...
                <div class="container-fluid home-fluid">
                            ...
                            <div class="widget-box">
                                <div class="widget-content">
                                    <ul class="home-icons" style="display: flex;justify-content: space-between;">
                                        ...
                                        <li>
                                            <a target="_blank" href="/content/vip/index.shtml" title="付费教学" rel="nofollow"><img data-lazy-src="../../../theme/${theme}/images/pino.png" alt="付费教学">
                                                <p>付费教学</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a target="_blank" href="/content/onlyvip/index.shtml" title="VIP教学"><img data-lazy-src="../../../theme/${theme}/images/vipbig.png" alt="VIP教学">
                                                <p>VIP教学</p>
                                            </a>
                                        </li>
                                        <!--<li>
                                                            ...
                                                            <a href="${item.document.viewUrl}" class="post-thumbnail" title="链接到  ${item.document.title}" target="_blank">
                                                                <c:choose>
                                                                    <c:when test="${empty item.document.productSmallImage}">
                                                                        <img  class="lazy" data-lazy-src="../../../theme/${theme}/images/LOGO.png" alt="${item.document.title}" style="width:100%;" />
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <img class="lazy" data-lazy-src="/file/${item.document.productSmallImage}"  alt="${item.document.title}" style="width:100%;" />
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </a>
                                                            <div class="head_box">
                    ...
                    <div class="row-fluid">
                            ...
                            <section class="span12 scroll-box">
                                <div class="widget-box">
                                    ...
                                    <div class="widget-content pic-list">
                                        <div class="swiper-containera" style='height:330px;'>
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <a href="/">
                                                        <img data-lazy-src="../../../theme/${theme}/images/footone.jpg" alt="" style='width:100%;height:100%;'>
                                                    </a>
                                                </div> 
                                            </div>
                                        </div>
                        ...
                        <!-- Three Columns -->
                        <section class="span4 column2" style="margin-left: 2.127659574468085%;">
                            <div class="widget-box">
                                <div class="widget-title">
