		...
		success : function (data) {
			...
			if (responseText != null) {
				...
				for (var i = 0; i < responseText.length; i++) {
                    ...
                    tTr += "<tr class='" + cc + "'><td >" + responseText[i].transactionId + "</td><td ><a href='/product/"+responseText[i].itemDataMap.productCode.dataValue.substring(0,5)+"/index.shtml'>" + responseText[i].itemDataMap.productServer.dataValue + "</a></td><td>" + responseText[i].enterTime + "</td><td>" + responseText[i].currentStatusName + "</td></tr>";
				}
		...
		success : function (data) {
			...
			if (responseText != null) {
				...
				for (var i = 0; i < responseText.length; i++) {
                    ...
                    tTr += "<tr class='" + cc + "'><td >" + responseText[i].transactionId + "</td><td ><a href='/product/"+responseText[i].product.productCode.substring(0,5)+"/index.shtml'>" + responseText[i].product.productName + "</a></td><td>" + responseText[i].enterTime + "</td><td>" + responseText[i].labelMoney + "元</td><td>" + responseText[i].count + "</td>" +
                        "<td>" + responseText[i].successMoney + "</td>元<td>" + responseText[i].currentStatusName + "</td></tr>";
