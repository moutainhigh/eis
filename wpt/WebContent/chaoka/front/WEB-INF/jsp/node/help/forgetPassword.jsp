...
<div id="mainbody">
        ...
        <div class="rightbar">
                ...
                <div class="forgetbodyindex">
                		<!--<div class="welcomes">欢迎注册${systemName}，请在下面输入您的信息</div>-->
                         <div class="clear"></div>
                         
                         
                         <ul>
                         <li><a href="/content/help/findPasswordByEmail.shtml"><img src="/style/emailf.jpg"/></a></li>
                         <li><a href="/content/help/findPasswordByPhone.shtml"><img src="/style/forgetphone.jpg"/></a> </li>
                         </ul>
