...
<script  src="/js/ui/findpasswordbyemail.js"></script>
 ...
 <div class="step">
            <ul>
               ...
               <li class="">完成</li>
				...
				<form name="findemailForm" id="findemailForm" action="/user/findPassword/email/submit.json" method="POST" >
			
					<p ><span class="txt">邮箱地址：</span> <span class="forms"><input type="text"  name="username" id="username"  size="40" onBlur="onCheckAccount(this)"/></span><span class="regok"></span></p>
					
					
                
					
				
					<p style="text-align:center;margin:30px 150px;"><input  type="submit" id="submitemail" value="发送验证邮件" /></p>
					</form>
				</div>  	
