    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
        ...
        <script src="/js/ui/bindmail.js"></script>
        ...
        <div id="usernamezh" style="display:block;margin:50px 5px 5px 68px; font-size:14px;color:#ff6d00;"></div><div
        id="dengji" style="margin:15px 5px 5px 68px;"></div>
        <div class="mobile_form" style="display:none">
        <p style="margin-bottom: 0px;">
        <span style="height: 30px; width:50px;
        line-height: 30px;
        margin-top: 10px;
        vertical-align: middle;">邮箱：</span>
        <span><input type="text" id="bindMailBox" style="height: 30px; width:250px;
        line-height: 30px;
        margin-top: 10px;
        vertical-align: middle;" name="bindMailBox"></span>

        </p>
        <p style="font-size: 12px;margin:0 0 0 60px; color:#d5d5d5" class="grey">请输入正确的邮箱地址</p>


        <p>
        <input type="button" name="bind" id="bind" class="submit_subscribe" value="发送绑定验证">
        </p>

        </div>
        <div class="mobile_form2" style="display:none">您的邮箱已绑定成功</div>
        <div class="clear"></div>
        </div>
        <div class="clear"></div>
        </div>
