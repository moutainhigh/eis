...
<script  src="/js/ui/editinfo.js"></script>
...
<div id="mainbody">
  ...
  <div class="rightbar">
    ...
    <div id="zlgj">
   <form  method="POST" action="/user/update/data.json" id="frontUserEdit" name="frontUserEdit">
      <input type="hidden" id="uuid" value="" name="uuid" >

      <input type="hidden" size="40"  value="" id="username" name="username">
      <p style="display:block;margin:30px 5px 5px 30px; font-size:14px;color:#ff6d00; display:inline">我的基本信息 如需修改密码，请前往<a href="/user/edit/security">账号安全管家</a></p>
      <div class="clear"></div>
      <p ><span class="txtedit">帐号：</span>
        <span class="inedit"></span>
        <span class="notifyedit"></span></p>
           <div class="clear"></div>
      <p ><span class="txtedit">昵称：</span>
       <span class="inedit"><input type="text" size="40" value="" id="nickName" name="nickName"></span><span class="notifyedit"></span>
      </p>
         <div class="clear"></div>
      <p><span class="txtedit">我是：</span>
        <span class="inedit"><select id="sex" name="sex">
          <option selected="" value="1">帅哥</option>
          <option value="2">美女</option>
        </select></span><span class="notifyedit"></span>
      </p>
         <div class="clear"></div>
      <p><span class="txtedit">安全邮箱：</span>
        <span class="inedit"><input type="text" size="40" value="beautiful200000@163.com" id="userKeyStore" name="userKeyStore"></span>
        <span class="notifyedit"> </span></p>
      <div class="clear"></div>
