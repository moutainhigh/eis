...
<script  src="/js/ui/paylist.js"></script>
...
<ul class="tabmoney">
    <li class="curr"><a href="/content/user/payList.shtml">最近支付记录</a></li>
    <li class="line"><a href="/content/user/buyList.shtml">最近购买记录</a></li>
    </ul>
    <div class="clear"></div>
<table width="670" border="0" cellspacing="1" cellpadding="0" id="paylists">
  <tr style="color:#FFFFFF;  font-size:12px; height:25px;">
    <th nowrap bgcolor="#003399">支付订单号</td>
    <th nowrap bgcolor="#003399">交易时间</td>
      <th nowrap bgcolor="#003399">提交金额</td>
    <th nowrap bgcolor="#003399">成功金额</td>
