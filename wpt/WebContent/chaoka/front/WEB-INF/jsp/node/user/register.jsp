        ...
        <div class="rightbar">
                ...
                <div class="registerbody">
                		<!--<div class="welcomes">欢迎注册${systemName}，请在下面输入您的信息</div>-->
                         <div class="clear"></div>
             <ul class="tab">
    <li class="curr"><a href="/content/user/register.shtml">邮箱注册</a></li>
    <li class="line"><a href="/content/user/phoneregister.shtml">手机注册</a></li>
				...
				<div class="registerf">
					...
					<p ><span class="txt">邮箱[账号]：</span> <span class="forms"><input type="text"  name="username" id="username"  size="40" onBlur="onCheckAccount(this)"/></span><span class="regok"></span></p>
