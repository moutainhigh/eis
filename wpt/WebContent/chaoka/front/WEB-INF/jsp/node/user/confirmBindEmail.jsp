...
<%@include file="/WEB-INF/jsp/include/common_reinfo.jsp"%>
  ...
  <div id="usernamezh" style="display:block;margin:50px 5px 5px 68px; background-color:  font-size:14px;color:#ff6d00;"></div><div id="dengji" style="margin:15px 5px 5px 68px;"></div>

  <div  id="jieguo" style="font-size:18px"></div>                   
    <div class="clear"></div>
  </div>
  <div class="clear"></div>
</div>
