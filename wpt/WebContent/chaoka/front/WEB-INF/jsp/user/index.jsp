...
<div id="mainbody">
  ...
  <div class="rightbar">
    <div class="position"><span>当前位置: <a href="/" target="_blank">${systemName}首页</a> - 我的账户</span></div>
    ...
    <div class="hengpai">
    	<c:choose> 
      	<c:when test="${frontUser.authType == 2}">
      		<div class="real_name_info" style="color:#ff6d00;">您已经完成实名认证</div>
      	</c:when>
      	<c:otherwise>
      		<div class="email_list" style="color:#ff6d00;"><a href="/user/realNameAuth.shtml" >您尚未完成实名认证，现在就去认证</a></div>
       		<div class="help" style="color:#ff6d00;">实名认证有什么好处</div>
       </c:otherwise>
       </c:choose>
    </div>
    <div class="hengpai">
    	<c:choose> 
      	<c:when test="${frontUser.authType == 3}">
      		<div class="real_name_info" style=";color:#ff6d00;">您已经完成收款账号上传</div>
      	</c:when>
      	<c:otherwise>
      		<div class="email_list" style="color:#ff6d00;"><a href="/user/bankAccount.shtml" >您尚未提交收款账号，无法收取寄售款，现在就去提交</a></div>
       		<div class="help" style="color:#ff6d00;">提交收款账号有什么好处</div>
       </c:otherwise>
       </c:choose>
    </div>
    <div class="clear"></div>
