									...
									<LINK rel=stylesheet type=text/css href="/style/Web.css"/>
										<LINK rel=stylesheet type=text/css href="/style/list.css"/>
											<LINK rel=stylesheet type=text/css href="/style/Footer.css"/>
												...
												<script src="/js/ui/real_name_auth.js"></script>
		...
		<div class="rightbar">
			...
			<div class="mobile_form" style="display: none">
				<p style="margin-bottom: 0px;">
					<span style="height: 30px; width: 50px; line-height: 30px; margin-top: 10px; vertical-align: middle;">真实姓名：</span> <span><input type="text" id="realName"
						style="height: 30px; width: 250px; line-height: 30px; margin-top: 10px; vertical-align: middle;" name="bindMailBox"></span>

				</p>
				<p style="margin-bottom: 0px;">
					<span style="height: 30px; width: 50px; line-height: 30px; margin-top: 10px; vertical-align: middle;">身份证号码：</span> <span><input type="text" id="idNumber"
						style="height: 30px; width: 250px; line-height: 30px; margin-top: 10px; vertical-align: middle;" name="bindMailBox"></span>
			...
			<div class="mobile_form2" style="display: none">您已完成实名认证</div>
			<div class="clear"></div>
		</div>
		<div class="clear"></div>
	</div>
