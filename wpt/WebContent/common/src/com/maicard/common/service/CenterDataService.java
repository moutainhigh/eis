...
public interface CenterDataService {
	 ...
	 */
	@Deprecated
	boolean setIfSameSign(String key, JmsObject object, long timeoutSec);
	 ...
	 */
	@Deprecated
	void unsetSignIfSameSign(String key, JmsObject object, long lockSec);
	 ...
	 * @return
	 */
	Set<Object> getHmKeys(String tableName);
	 ...
	 * @return
	 */
	long addToList(String listName, String value);
	 ...
	 * @return
	 */
	long removeFromList(String listName, long index, String value);
