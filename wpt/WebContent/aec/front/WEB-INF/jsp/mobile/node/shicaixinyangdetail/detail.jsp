		 ...
		 <div class="box_title">
			<div class="wid90">
				<ul class="yuedulist">
					...
					<li>
					<c:choose>
					<c:when test="${document.documentDataMap.get('praised').dataValue==true}"><img src="../../../../image/mobile/header/preview_unlike_icon.png" style="width:20px;height: 20px;margin-top:-5%;" class="favorited" onClick="unlike(${document.udid})"></c:when>
					<c:otherwise>
					<img src="../../../../image/mobile/header/preview_unlike_icon1.png" style="width:20px;height: 20px;margin-top:-5%;" class="favorite" onClick="like(${document.udid})"></c:otherwise>
					</c:choose>
	  ...
	  <ul class="buy-list wid90">
		...
		<li style="margin-left:8%;">
		   ...
		   <div class="box_right2">
			  ...
			  <div class="divCenter"> <span class="ware_from commentCont"><c:if test="${!empty i.title}">${i.title}:</c:if>${i.content}</span></div>
