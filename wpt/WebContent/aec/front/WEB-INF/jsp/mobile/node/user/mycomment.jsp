...
<body>
    ...
    <div class="wrapper">
        <ul class="favoriteList">
            <c:forEach var="commention" items="${comment}"  varStatus="i"> 
                    <c:choose>
						<c:when test="${empty commention}">
							<li>没有更多内容了</li>
						</c:when>
						<c:otherwise>
                            <li style="height:auto;">
                                <div class="afbox">
                                    ...
                                    <div class="zhtw">                           
                                        ...
                                        <div class="other" style="margin: 5px 0;"><div><fmt:formatDate value="${commention.createTime}"  type="both"/></div>   </div>
                                    </div>
                                </div>                      
                            </li>
						</c:otherwise>
