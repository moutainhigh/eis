...
<%@include file="/WEB-INF/jsp/include/tags.jsp" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"> 
<head>
...
<link rel="stylesheet" type="text/css" href="../../../../css/mobile/jingcaishike.css"/>
...
<body>
 <div class="header" id="header">
	  <a class="back" href="/content/shicaixinyang/index.shtml?subTitle=jingcaishike"></a><span>精彩时刻</span><a class="list1" onclick="vanish()">
 </div>
	<div id="wrapper_1">
	  ...
	  <div class="box_title">
			<div class="wid90">
				<span style="color:#666666"><fmt:formatDate value="${document.publishTime}" type="date"/></span>
			</div>
	  </div>
	  ...
	  <div class="fapiao">
			<div class="wid90">
		         <div class="box_left martop10">
					<span>上一篇：<a href="${lastDocument.viewUrl}">${fn:substring(lastDocument.title ,0,5)}${fn:length(lastDocument.title)>5?"..":""}</a></span>
					<span class="orange">|</span>
					<span>下一篇：<a href="${nextDocument.viewUrl}">${fn:substring(nextDocument.title ,0,5)}${fn:length(nextDocument.title)>5?"..":""}</a></span>
				</div>
			</div>
	  </div>
	   ...
	   <div class="comment_title martop40">
		...
		<div class="comment_box">
	        <form>
			   ...
			   <textarea placeholder="评论将由以先后台筛选后显示，对所有人显示" maxlength=400 id="suggestContent" style=""></textarea>			  
	...
	<div class="comment_title">
	   <div class="wid90" style="text-align:center;display:flex;justify-content:center">
			<div class="linellae"></div>	
			<div class=" write_comment"><span style="margin:0 auto;">精选评论（${commentCount}）</span></div>
			<div class="linellae1"></div>
	  </div>
	</div>
