...
<meta name="renderer" content="webkit">
<title>${systemName}node/cart</title>
	...
	<div id="gouwuche_center">
		...
		<div id="center_right">
			...
			<div class="xiaoji">
			   ...
			   <span class="cart_del"><span id="edit" onclick="edit(this,event)">编辑</span><span class="cart-del-box" id="cart-del-box"><span onclick="deleteCart('${str.transactionId}',event)">删除</span> | <span id="complete" onclick="complete(this,event)">完成</span></span></span>
			</div>
