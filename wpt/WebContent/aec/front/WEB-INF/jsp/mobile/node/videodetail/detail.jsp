					...
					<li>
					  <c:choose>
					  	<c:when test="${document.documentDataMap.get('favorited').dataValue==true}">
					  		<img src="../../../../image/mobile/header/praiseChecked.png" style="width:20px;height: 20px;margin-top:-5%;" class="praised" onClick="uncollection(${document.udid})">
					  	</c:when>
					  	<c:otherwise>
					  	    <img src="../../../../image/mobile/header/icon.png" style="width:20px;height: 20px;margin-top:-5%;" class="praise" onClick="collection(${document.udid})">
					  	</c:otherwise></c:choose><span>${favoriteCount}</span></li>
				</ul>
			</div>
		 </div>
