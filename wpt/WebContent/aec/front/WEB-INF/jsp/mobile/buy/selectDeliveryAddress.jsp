   ...
   <div class="line"></div>
	...
	<div class="wid90 martop20 pay">
	  <div class="left">
		...
		<img src="/image/mobile/weixin.png" style="margin-right:5px;"/>微信支付
	  </div>
	</div>
	</c:forEach>
   ...
   <ul class="order-status">
     ...
     <ul class="order-status useCoupon">
		 <div class="wid90">
				...
				<div class="right  box_r martop10">
				    <div class="left">
			           <p style="color:#A3A3A3;" class="martop10" >现有代金券总金额:<span class="orange">￥<span class="currentGiftMoney"><c:choose><c:when test="${!empty money.giftMoney}">${money.giftMoney}</c:when><c:otherwise>0.00</c:otherwise></c:choose></span></span></p>
			        </div>
