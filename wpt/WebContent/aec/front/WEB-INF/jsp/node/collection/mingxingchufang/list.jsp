...
<body id="wid-100">
	...
	<div class="box_container padbtm50">
	    <!-- <h3 class="martop30  orange">精选视频</h3> -->
		<ul class="list_Video wid-80 martop30">
			   <c:forEach var="document" items="${newsList}" >
			    ...
			    <a href="${document.viewUrl}">
			       <div style="position: relative;" >
			            ...
			            <div style="z-index: 99;width:53px;height: 53px;top:50%; left:50%;margin:-26px 0px 0px -26px;position: absolute!important ;background-image: url(../../../image/play.png);" ></div>
			    	</div>
			    	<!-- <p class="time_bar"></p>  --> 
