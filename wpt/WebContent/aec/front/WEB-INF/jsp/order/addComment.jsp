	 ...
	 <div class="rightbox">
	   ...
	   <div class="BoxOrder">
		  ...
		  <ul class="orderlist fo-12">
		     ...
		     <li class="li1 lineH40">
			  <!--<span>${order.cartId}</span>-->
			  <p class="orderNum">订单编号：${item.cartId}</p>
			   <div class="productlist">
				   <img src="${item.itemDataMap.get('productSmallImage').dataValue}" />
			...
			<li class="li4 orange lineH60">
			     <p>￥<fmt:formatNumber value="${item.requestMoney + deliveryOrder.fee.money}" pattern="##.##" minFractionDigits="2" ></fmt:formatNumber></p>
				 <p>(运费￥${deliveryOrder.fee.money})</p>
			 </li>
			 <li class="li5 lineH60">
			    <p>${item.currentStatusName}</p>
			    <a href="javascript:getDeliveryInfo(${deliveryOrder.deliveryOrderId});"><p class="orange">查看物流</p></a>
				<p class="orange"><a  href="/order/get.shtml?cartId=${item.cartId}" class="orange">订单详情</a></p>
