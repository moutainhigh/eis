		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				var div= '';
					...
					// 创建带有拖动的html
					div += '<form id="uploadForm" action="'+para.url+'" method="post" enctype="multipart/form-data">';
					div += '<div class="dropbox box_container_left"></div><div class="box_container_right"><p class="orange fo-14">直接拖进图片即可</p><a class="btnSave martop45 upload_submit_btn">保存</a></div></form>';
