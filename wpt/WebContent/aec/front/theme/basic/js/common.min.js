...
$(function() {
	...
	if (Cookie.getCookie("eis_username") != null) {
		$(".username_res").html("<a href='/content/user/pcenter.shtml' class='orange'>" + b + "</a>" + "您好！");
		$(".zhanghu_res").html("<a class='search_show'><img src='../../../image/zoom3.png' style='width:16px; height:16px;'></img> </a><a href='/cart.shtml'><img src='../../../image/cart.png' style='width:16px; height:16px; '' /></a><a href='/content/user/pcenter.shtml?favPage=1&favRows=8' class='orange' style='margin-top:10px;'>进入我的账户</a> &nbsp;<a href='#' onClick='logout();' class='orange'>退出</a>")
		$(".lHidden").html('');
	}
	$(".list4 img").each(function(k, a) {
		new JumpObj(a, 10)
	});
	$(".list5 li .box_img").hover(function() {
...
$(function() {
	...
	$('.menu a').each(function() {
		if ($($(this))[0].href == String(window.location)) $(this).addClass('sel')
	})
})