$(function() {
    $('.spinner').spinner();
     var $cpxq = $('#cpxq');
     var $yhpj = $('#yhpj');
     var $addtocard = $('.add_cart');
     var $all = $('#all');
     var $good_reputation = $('#good_reputation');
     var $middle_reputation = $('#middle_reputation');
     var $bad_reputation= $('#bad_reputation');
 $addtocard.click(function(){
    ...
    $cpxq.click(function(){
        ...
        $yhpj.removeClass('current');
        $cpxq.addClass('current');
        $('.yhpj').css('display','none');
        $('.cpxq').css('display','block');
    })
    $yhpj.click(function(){

        $cpxq.removeClass('current');
        $yhpj.addClass('current');
        $('.cpxq').css('display','none');
        $('.yhpj').css('display','block');
    })

    
     $all.click(function(){
        $middle_reputation.removeClass('orange');
        $good_reputation.removeClass('orange');
        $bad_reputation.removeClass('orange');
        $all.addClass('orange');
   ...
   $good_reputation.click(function(){
     setvtnStatus()
      $all.removeClass('orange');
       $middle_reputation.removeClass('orange');
        $bad_reputation.removeClass('orange');
       $good_reputation.addClass('orange');
        $('.middle_reputation').css('display','block');
        $('.good').css('display','block');
        $('.all').css('display','none');
        $('.well').css('display','none');
        $('.wrong').css('display','none');
    })
    $middle_reputation.click(function(){
        $all.removeClass('orange');
       $good_reputation.removeClass('orange');
        $bad_reputation.removeClass('orange');
       $middle_reputation.addClass('orange');
        setvtnStatus()
         $middle_reputation.addClass('orange');
       
        $('.bad_reputation').css('display','block');
        $('.well').css('display','block');
        $('.all').css('display','none');
        $('.good').css('display','none');
        $('.wrong').css('display','none');
    })
    $bad_reputation.click(function(){
        $all.removeClass('orange');
       $good_reputation.removeClass('orange');
        $middle_reputation.removeClass('orange');
       $bad_reputation.addClass('orange');
        setvtnStatus()
        $bad_reputation.attr("color","#ff6400");
     ...
     function setvtnStatus(){
       
        $all.attr("color","#000");
        $('.middle_reputation').css('display','none');
        $('.bad_reputation').css('display','none');
        $('.all').css('display','none');
        $('good_reputation').css('display','none');
     }
    // 图片上下滚动
    ...
    function fixedPosition(e) {
        ...
        $("#bigView img").css({ "left": scrollX * -1, "top": scrollY * -1 });
         $("#bigView").css({ "top": 180, "left": $(".preview").offset().left + $(".preview").width() + 15 });
        return { left: X, top: Y };
    }
	...
	var timer = setInterval(function(){
		if (sys_second > 1) {
			...
			$(second_elem).text(second<10?"0"+second:second);//计算秒杀
			 ...
			 //location.reload();
			 clearInterval(timer);
			 $(".btns").html("<input type='button' value='已结束' class='btn_buy_gray'/>")
		}
	}, 1000);
}
