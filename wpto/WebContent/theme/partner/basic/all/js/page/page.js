...
;(function (factory) {
	...
	var Pagination = function(element,options){
		...
		this.filling = function(index){
			...
			html += opts.jump ? '<input type="text" class="'+opts.jumpIptCls+'"><a href="javascript:;" class="'+opts.jumpBtnCls+'">'+opts.jumpBtn+'</a><span class="total_page" style="width:100px;">共<font style="font-size: 14px;padding: 0 2px 0 2px;">0</font>页</span>' : '';
			$obj.empty().html(html);
		};
