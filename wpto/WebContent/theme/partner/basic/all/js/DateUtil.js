...
var DateUtil = function(){
    ...
    */
    ...
    //获取一天中最小得时间
    this.minTimeOfDay = function(date)
    {
    	date = arguments[0] || new Date();
    	var dateStr = dateToStr("yyyy-MM-dd",date)+" 00:00:00";
    	return strToDate(dateStr);
    };
    
  //获取一天中最大得时间
    this.maxTimeOfDay = function(date)
    {
    	date = arguments[0] || new Date();
    	date = minTimeOfDay(date);
    	date = dateAdd("d",1,date);
    	date = dateAdd("s",-1,date);
    	return date;
    };
    return this;
}();
