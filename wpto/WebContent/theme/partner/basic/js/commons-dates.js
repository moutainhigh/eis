...
(function () {
    ...
    getSmpFormatDate = function (date, isFull) {
        ...
        if (isFull == true || isFull == undefined) {
            pattern = "yyyy-MM-dd 23:59:59";
        } else {
            pattern = "yyyy-MM-dd";
        }
        return getFormatDate(date, pattern);
    };
    getSmpFormatDate2 = function (date, isFull) {
        var pattern = "";
        if (isFull == true || isFull == undefined) {
     ...
     *
     */
    get3YearsLaterDayFormat = function (date) {
     ...
     * 获取当前时间的前7天
     * */
    getBefore7dayFormat = function (date) {
        var yesterdayMillons = date.getTime() - 1000 * 60 * 60 * 24*7;
        var yesterday = new Date();
        yesterday.setTime(yesterdayMillons);
        var yearStr = yesterday.getFullYear();
        var dayStr = yesterday.getDate();
     ...
     * 获取当前时间的前一天
     * */
    getTorrowDayFormat = function (date) {
        var yesterdayMillons = date.getTime() + 1000 * 60 * 60 * 24;
        var yesterday = new Date();
        yesterday.setTime(yesterdayMillons);
        var yearStr = yesterday.getFullYear();
