  ...
  /*for(var f=0;f<files.length;f++){
   ...
   // if(columnName != "productGallery"){
		...
		if ($(this).parents('a').hasClass('videodom')) {
			...
			var html1='<a class="btn_addPic inputa" href="javascript:void(0);"><span>添加文件</span> <input type="file"  class="filePrew" id="'+columnName+currentImgLength+'"  name="'+columnName+currentImgLength+'" class="blue" data-name="'+columnName+'" /></a>';
