...
<html lang="zh-CN">
  ...
  <body>
	...
	<form:form commandName="template" name="templateForm" id="templateForm" action="/template/update.shtml">
	<form:hidden path="templateId"/>
		...
		<tr id="lastTr"> <td align="center" colspan="2"><input type="submit" class="keepbtn" value="确 认"/></td></tr>
		</table>
	</form:form>
</div>
        </div>
