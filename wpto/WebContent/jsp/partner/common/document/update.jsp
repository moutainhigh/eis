  ...
  <body>
	  ...
	  <%@include file="/WEB-INF/jsp/common/include/menu.jsp"%>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="table-responsive">	
				<form:form id="documentForm"  commandName="document" name="documentForm" action="/document/update.shtml" enctype="multipart/form-data" onsubmit="return false">
				...
				<input type="hidden" name="workflowInstanceId" value="${workflowInstanceId}"/>
				 <table class="table table-striped">
					...
					<tr style="display:none;">
						<td></td>
						<td><input type="text" name="documentCode" value="${document.documentCode}" /></td>
					</tr>
					<tr style="display:none;">
						<td></td>
						<td><input type="text" name="documentTypeId" value="${document.documentTypeId
}" /></td>
					</tr>
					<tr>
						<td>文档类型</td>
				...
				<div class="submit"><input type="submit" class="keepbtn" value="保存文档" class="addPro"></div>
				</form:form>
			</div>
        </div>
      </div>
	...
	//产品编码
		$(function(){
			var popup="";
			var activity="";
			if($("#documentTypeId").val() == 171005 || $("#documentTypeId").val() == 171004){
				$.ajax({
					type:"GET",
