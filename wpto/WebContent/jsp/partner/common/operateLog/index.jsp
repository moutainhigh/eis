	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h2 class="sub-header"><span>用户操作日志</span></h2>
					...
					<table class="table table-striped" style="margin-top: 15px;">
						...
						<tbody>
							<c:forEach var="i" items="${rows}">
								<tr>
									<td><fmt:formatDate value='${i.operateTime}' pattern='yyyy-MM-dd HH:mm:ss'/></td>
									<td>${i.operate.username}[${i.uuid}]</td>
									<td>${i.ip}</td>
									<td>${i.objectType} ${i.objectId}</td>
									<td>${i.operateCode}</td>									
									<td><spring:message code="Status.${i.operateResult}" /> ${i.operateResult}</td>									
								</tr>
							</c:forEach>
						</tbody>
					</table>
