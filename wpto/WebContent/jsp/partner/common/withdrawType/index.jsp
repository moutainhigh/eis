...
.switch-button{
  ...
  <%@include file="/WEB-INF/jsp/common/include/header.jsp"%>
    ...
    <%@include file="/WEB-INF/jsp/common/include/menu.jsp"%>
      ...
      <h2 class="sub-header"><span>提现类型管理</span></h2>
    
      <p><a href="<c:url value='/withdrawType/create'/>" class="addmoban">+ 新增提现类型</a></p>
      <div class="table-responsive">      
         <table class="table table-striped">
          ...
          <c:forEach var="i" items="${rows}">
            <tr>
                      <td>${i.withdrawTypeId}</td>
                      <td>${i.withdrawTypeName}</td>
                      <td>${i.arrivePeriod}</td>
                      <td>
                      <spring:message code='CommissionType.${i.commissionType}'/>
                      </td>
                      <td>
                      <spring:message code='CommissionChargeType.${i.commissionChargeType}'/>
                      </td>
  	                  <td>
                        <font
                        <c:choose>
                        ...
                        <td>
                         ...
                         <em></em>
                         <input type="checkbox" checked currentStatus="${i.currentStatus}" data-id="${i.withdrawTypeId}" data-name="${i.withdrawTypeName}"/>
                      </span>
                        </td>
              ...
              <ul style="position:absolute; width: 58px; padding-right: 10px; padding-left: 10px; margin-left: -28px; top:40px;left:50%;line-height: 30px; list-style: none; z-index: 100; border: 1px solid rgb(221, 221, 221); border-radius: 5px; display: none; background-color: rgb(255, 255, 255);" class="toolbtns">
                <li><a href="<c:url value='/withdrawType/get/${i.withdrawTypeId}.shtml'/>">查看</a></li>
...
if (jurisdictiontext.indexOf('edit')>-1) {
  ...
  function ajaxfunction(id,value,name){
    var dataarry = {'withdrawTypeId':id,'currentStatus':value,'updateMode':'currentStatus'};
