    ...
    <div class="container-fluid">
		<div class="row">
			...
			<div class="message" style="display:none;">
				...
				<p style="text-align:center;margin-top: 57px;"><a href="<c:url value='/partner.shtml'/>"  class="completebtn" style=" font-size: 15px;padding: 10px 14px; margin-right: 12px;">返回商户列表</a><span class="querenbtn" style=" cursor: pointer;font-size: 15px;padding: 10px 14px;">继续添加商户</span></p>
			</div>
			</div>
