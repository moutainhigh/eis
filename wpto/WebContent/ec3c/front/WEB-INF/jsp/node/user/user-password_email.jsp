...
<div class="blank"></div>
 <div id="ur_here">
当前位置: <a href="/">首页</a> <code>&gt;</code> 用户中心 <code>&gt;</code>找回密码
</div>
</div>
<div class="blank"></div>
...
<div class="usBox clearfix">
  <div class="usBox_1 f_l">
    <div class="login_tab">
    <ul>
        <li ><a href="/user/login.shtml">用户登录</a></li>
        <li class="active"><a href="/content/user/forgetpassword.shtml">找回密码</a></li>
    </ul>
    </div>
   <form name="formLogin" id="formLogin"  method="post">
        <table width="100%" border="0" align="left" cellpadding="3" cellspacing="5">
          <tr>
            ...
            <td width="65%"><input name="username" type="text" size="25" class="inputBg" id="usernames" /></td>
          </tr>
          <tr>
            <td width="25%" align="right">请输入您的手机号：</td>
            <td>
                <input name="log" type="text" id="wpuf-user_email" size="15"  class="inputBg"/>            
            </td>
          </tr>
          <tr>
            ...
            <td>
                ...
                <input type="button" class="btn_sendCode" id="btnSendCode" value="发送验证码" onclick="findpasswordMessage()" style="padding: 5px;background: #f60;color:#fff;border: 0;border-radius: 5px;" />
            </td>
          </tr>
           <tr>
           ...
           <tr>
               <td></td>
               <td align="left"><input type="button" name="wp-submit" id="wp-submit" value="提交" onclick="findpassword()" class="input" size="20"/></td>
           </tr>
      </table>
    </form>
    <div class="blank"></div>
