...
<div class="blank"></div>
 <div id="ur_here">
	当前位置: <a href="/">首页</a><code>&gt;</code> <a href="/content/about/about.shtml">关于我们</a> <code>&gt;</code> 购物流程 
</div>
</div>
<div class="blank"></div>
    ...
    <div class="box">
     <div class="box_1">
      <div class="userCenterBox boxCenterList clearfix" style="_height:1%;" id="notLogin">
         ...
         <font class="f5 f6" style="font-size:18px; ">购物流程</font><br />
         </div>
                           <div style="padding:8px; margin-top:15px; text-align:left; border-top:1px solid #ccc;">
         
                      下一篇:<a href="/content/about/AfterSalesProcess .shtml	" class="f6">售后流程</a><br />
