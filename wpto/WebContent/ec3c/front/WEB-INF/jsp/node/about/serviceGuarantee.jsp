...
<div class="blank"></div>
 <div id="ur_here">
	当前位置: <a href="/">首页</a><code>&gt;</code> <a href="/content/about/about.shtml">关于我们</a> <code>&gt;</code> 售后服务保证 
</div>
</div>
<div class="blank"></div>
...
<div class="blank"></div>
 ...
 <div class="tc" style="padding:8px;">
         <font class="f5 f6" style="font-size:18px; ">售后服务保证</font><br />
         </div>
                   <p>&nbsp;<span style="color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif, 宋体; line-height: 18px;">&nbsp;&nbsp; 我公司体现&ldquo;顾客第一、信誉第一&rdquo;的服务宗旨，为顾客提供长期的技术支持和全方位服务。</span></p>
<p style="margin: 0px; padding: 0px; border: none; list-style-type: none; color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif, 宋体; line-height: 18px;">1、 售后服务承诺书投标方拥有健全的售后服务网络机构，包括专门的安装维修服务队，用户的定期访问和信息反馈，安装指导和技术咨询。全国各大中型城市设立办事处，立争在最短的时间内解决出现的故障、质量问题，让客户安心、放心。<br />
&nbsp;<br />
2、 质量保证期<br />
产品质保期限为一年<br />
3、 售后服务承诺书日常管理<br />
用户就是上帝，售后服务更是我们工作的重中之重，我们会定期进行回访用户，了解电子设备运行的状况，做好跟踪记录，把好质量关；<br />
<%--4、 售后服务承诺书售前，在技术问题上与用户保持对接，保证产品的符合性，在生产过程开始之前，提供样品由用户及监理单位进行审查，合格后方可进行批量生产。</p>--%>
<%--<p style="margin: 0px; padding: 0px; border: none; list-style-type: none; color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif, 宋体; line-height: 18px;">5、 售后服务承诺书培训计划<br />--%>
<%--&nbsp;<br />--%>
<%--本公司负责开通调试的工程，均可得到本公司提供现场免费培训一次，培训内容为使用设备的操作及日常维护；本公司厂每年春、秋两季举办用户学习班，由专业人员集中授课，主要讲授系统操作、日常维护及简单故障的排除。<br />--%>
<%--技术培训方式有现场培训、集中培训两种方式。<br />--%>
<%--现场培训由项目的技术负责人负责，集中培训由公司技术人员担任。<br />--%>
<%--现场培训是在设备投入使用之前，对安装人员、管理人员的培训提供的免费培训，培训地点设在施工现场。培训内容包括安装知识、系统组成及系统操作维护等讲解。<br />--%>
<%--定期培训是对管理人员进行全面培训。内容包括系统的设计规范、验收规范、系统的维护与管理等。</p>          --%>
          <div style="padding:8px; margin-top:15px; text-align:left; border-top:1px solid #ccc;">
         
                      下一篇:<a href="/content/about/ReturnPrinciple.shtml" class="f6">退换货原则</a><br />
