...
<body>
 <script type="text/javascript" src="/theme/${theme}/js/jquery-1.11.3.min.js" ></script><script type="text/javascript" src="/theme/${theme}/js/jquery.json.js" ></script> <script type="text/javascript" src="/theme/${theme}/js/utils.js" ></script>
...
<div class="usBox">
  <div class="usBox_2 clearfix">
    <form action="http://www.ktwwg.top/user.php" method="post" name="getPassword" onsubmit="return submitPwdInfo();">
        <br />
