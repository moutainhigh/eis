package com.maicard.ec.partner.controller;
...
public class AddressBookController extends BaseController{
	...
	public String list(HttpServletRequest request, HttpServletResponse response, ModelMap map, AddressBookCriteria addressBookCriteria) throws Exception {

		final String view = "ec/addressBook/list";
		long ownerId = 0;
		try{
	...
	public String get(HttpServletRequest request, HttpServletResponse response, ModelMap map,
		...
		final String view = "ec/addressBook/get";
		if(addressBookId == 0){
