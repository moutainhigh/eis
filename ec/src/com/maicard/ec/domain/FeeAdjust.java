 ...
 *
 */
public class FeeAdjust extends EisObject {
	
	private static final long serialVersionUID = -6815859154742363184L;

	private long feeAdjustId;
	...
	public long getFeeAdjustId() {
		return feeAdjustId;
	}

	public void setFeeAdjustId(long feeAdjustId) {
		this.feeAdjustId = feeAdjustId;
	}
